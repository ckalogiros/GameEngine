 ...
 */
// export class Section2 extends Mesh {
export class Section2 extends T_Rect {
   ...
   for (let i = 0; i < parent.children.count; i++) {
      ...
      if (parent.type & MESH_TYPES_DBG.SECTION_MESH) {
         ...
         if (mesh.type & MESH_TYPES_DBG.TEXT_MESH) {
            ...
            mesh.geom.pos[0] = cur_pos[0] - (mesh.geom.dim[0] * num_chars)/2;// Fixes the button mis-alignment
