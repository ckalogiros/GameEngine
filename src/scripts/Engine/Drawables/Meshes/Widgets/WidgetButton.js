...
export class Widget_Button extends Widget_Label {
   ...
   constructor(text, Align = (ALIGN.HOR_CENTER | ALIGN.VERT_CENTER), pos = [200, 300, 0], fontSize = 4.4, col = GREY1, textCol = WHITE, pad = [10, 5], bold = .4, style = [0, 6, 2], font = TEXTURES.MSDF_CONSOLAS_1024) {
