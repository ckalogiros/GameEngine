...
export class Widget_Text_Label extends Mesh{
    ...
    constructor(text, pos, fontSize, scale = [1, 1]) {
        ...
        const textmat = new FontMaterial(WHITE, FONTS.SDF_CONSOLAS_LARGE, text, [.5, sdfouter])
    ...
    CheckHover() {
        this.geom.CheckHover();
     }

    // GetGfxIdx() {
    //     /** Get all widget's progs and vertexBuffer indexes */
    //     const gfxIdx = [
    //         // [this.textMesh.gfxInfo.prog.idx, this.textMesh.gfxInfo.vb.idx],
    //         [this.textMesh.gfxInfo.prog.idx, this.textMesh.gfxInfo.vb.idx],
    //     ];
    //     return gfxIdx;
    // }
