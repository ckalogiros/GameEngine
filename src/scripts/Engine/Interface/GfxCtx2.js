...
export class Gfx_Pool2 extends M_Buffer {
   ...
   GenerateGfxCtx(sid, sceneIdx, mesh_count, FLAGS, gfxIdx=[INT_NULL, INT_NULL]) {
      ...
      if (FLAGS & GFX.NEW) {
          ...
          */
            ...
            // ... Check if an avaliable Private gfx buffer exists ...
            ...
            if (foundIdx !== INT_NULL) {
               ...
               gfx.gfx_ctx.sessionId = _sessionId;
               return gfx;
            }
...
export function Gfx_end_session2(setPrivate) { return _gfx_pool.SessionEnd(setPrivate); }

// mesh_count is nesessary for calculating vertex buffer attribute offset for Text Meshes
export function Gfx_generate_context2(sid, sceneIdx, mesh_count, FLAGS, gfxidx) {
...
export function Gfx_activate2(mesh) { _gfx_pool.ActivateRecursive(mesh); }
export function Gfx_deactivate2(mesh) { _gfx_pool.DeactivateRecursive(mesh); }

export function Gfx_pool_print2() {
