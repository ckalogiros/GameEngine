...
// function Animations_create_scale_up_down() {
    
//     const maxUpScale = 1.3;
//     const minDownScale = 1.0;
...
//             ButtonRunScaleAnimation(i, upScaleFactor, maxUpScale);
//             state.inUpScale = true;
//         }
//         else if (!state.inHover && area.scale[0] > minDownScale) {
            
//             ButtonRunScaleAnimation(i, downScaleFactor, maxUpScale);
