...
import { Gl_get_progams_count, Gl_progs_get_group, Gl_progs_get_prog_byidx, Gl_progs_get_vb_byidx, Gl_progs_set_vb_texidx, Gl_set_vb_show } from "../../../Graphics/GlProgram";
...
export function Gfx_set_vb_show(progs_groupidx, progIdx, vbIdx, flag){ Gl_set_vb_show(progIdx, vbIdx, progs_groupidx, flag); }
...
export function Gfx_progs_get_group(progs_groupidx){ return Gl_progs_get_group(progs_groupidx); }
